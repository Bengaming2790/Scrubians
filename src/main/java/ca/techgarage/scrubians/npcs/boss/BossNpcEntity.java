 ...
 */
public class BossNpcEntity {

    private static final String NPC_ID_TAG = "ScrubianBossNpcId";
    private static final String BASE_TYPE_TAG = "ScrubianBossBaseType";

    /**
     * Spawn a boss NPC using a vanilla entity type
     *
     ...
     */
    public static Entity spawnBossNpc(ServerWorld world, int npcId, String entityTypeString, Vec3d spawnPos) {
     ...
     */
    private static void applyStats(LivingEntity entity, BossNpcRegistry.Stats stats) {
        // Max health
        ...
        if (entity.getAttributeInstance(EntityAttributes.SCALE) != null) {
            entity.getAttributeInstance(EntityAttributes.SCALE).setBaseValue(stats.sizeMultiplier);
        }
     ...
     * @return the boolean
     */
    public static boolean isBossNpc(Entity entity) {
     ...
     */
    public static void updateEntityStats(Entity entity, BossNpcRegistry.Stats stats) {
        if (entity instanceof LivingEntity living) {
